...
setuptools.setup(
    name="Mini",                     # This is the name of the package
    version="0.0.1",                        # The initial release version
    author="Haoran Li",                     # Full name of the author
    description="Mini:a highly-accurate bioinformatics tool for transcript abundance estimation.",
    ...
    py_modules=["Mini"],             # Name of the python package
